...
// environment for hints about what port to bind to, selecting the OGO_BIND
...
// environment. It examines the OGO_BIND environment variable, Einhorn,
...
func Sniff() string {
	if bind := os.Getenv("OGO_BIND"); bind != "" {
		return bind
